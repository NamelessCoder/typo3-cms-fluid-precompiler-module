...
/**
 * Class NodeShortNameViewHelper
 */
class NodeShortNameViewHelper extends AbstractViewHelper
{
    ...
    {
        $instance = $renderChildrenClosure();
        if ($instance instanceof ExpressionNodeInterface) {
